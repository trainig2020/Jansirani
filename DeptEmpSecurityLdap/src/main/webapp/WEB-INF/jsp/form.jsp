...
<body>
	...
	<div id="header">
		<div class="any">
			<c:if test="${loggedInUser eq 'bob'}">
				<a href="listDept"><font color="white"><spring:message
							code="label.admin"></spring:message></font></a>
			</c:if>
		</div>
		<div class="logout">
	...
	<div id="footer">
		<h2>
			<a href="DeptEmpLdap?siteLanguage=en">English</a>|<a
				href="DeptEmpLdap?siteLanguage=fr">French</a>
		</h2>
	</div>
