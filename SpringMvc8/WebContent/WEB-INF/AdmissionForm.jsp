...
<body>
	<link rel="stylesheet" href="<spring:theme code='styleSheet' />"
		type="text/css" />
	<p>
		<a href="/SpringMvc8/admissionForm.html?siteTheme=green">Green</a> |
	
		<a href="/SpringMvc8/admissionForm.html?siteTheme=red">Red</a>
	</p>
	<a href="/SpringMvc8/admissionForm.html?siteLanguage=en">English</a> |
	<a href="/SpringMvc8/admissionForm.html?siteLanguage=tamil">French</a>

	<h1>${headerMessage}</h1>
	<h1><spring:message code="label.studentAdmissionForm" /></h1>
	<form:errors path="student.*" />
	<form action="/SpringMvc8/submitAdmissionForm.html" method="post">
		<table>
			<tr>
